...
// Mockup method
function onRegister() {
  console.log("Mock Register:", email.value, password.value);
  // Redirigir al login o dashboard como mockup
  router.push("/login");
}
</script>
...
<template>
  <div class="min-h-screen flex items-center justify-center p-6 bg-[#12131A] relative overflow-hidden">
    ...
    <div class="w-full max-w-[420px] bg-[#09090B] rounded-2xl p-10 shadow-2xl relative z-10 border border-white/5">
      <div class="mb-10">
        <h1 class="text-3xl font-bold text-white mb-2">Welcome To Dashboard</h1>
        <p class="text-sm text-gray-400">Create your account</p>
      </div>

      <div class="space-y-6">
        <!-- E-mail -->
        <div class="relative">
          <label class="block text-xs font-medium text-gray-500 mb-2">E-mail</label>
        ...
        <!-- Repeat password -->
        <div class="relative">
          <label class="block text-xs font-medium text-gray-500 mb-2">Repeat password</label>
          <div class="relative flex items-center">
            <input 
        ...
        <button 
          @click="onRegister"
          class="w-full mt-6 bg-[#1E2028] text-[#E9C46A] py-3 rounded-lg font-medium hover:bg-[#252832] transition-colors flex justify-center items-center"
        >
          Create an account
        </button>
        ...
        <div class="mt-8">
          <div class="flex items-center space-x-4">
            <span class="text-xs text-gray-500 whitespace-nowrap">Sign Up with</span>
        ...
        <div class="mt-8 text-xs text-gray-500">
          ...
          <router-link to="/login" class="text-[#E9C46A] hover:text-[#f4d17b] transition-colors ml-1 font-medium">Log In</router-link>
        </div>
      </div>
    </div>
  </div>
